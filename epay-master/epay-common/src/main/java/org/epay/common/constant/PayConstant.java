package org.epay.common.constant;
...
public class PayConstant {
	...
	public final static String PAY_CHANNEL_PC_MGR = "PC_MGR";	    			// 管理平台支付
	public final static String PAY_CHANNEL_JD_PAY = "JD_PAY";	    			// 京东支付
	public final static String PAY_CHANNEL_UNION_PAY = "UNION_PAY";	    		// 银联支付
	
	public final static String CHANNEL_NAME_WX_JSAPI = "微信公众号支付";
	public final static String CHANNEL_NAME_WX_NATIVE = "微信原生扫码支付";
	public final static String CHANNEL_NAME_WX_APP = "微信APP支付";
	public final static String CHANNEL_NAME_WX_MWEB = "微信H5支付";	
	public final static String CHANNEL_NAME_IAP = "苹果应用内支付";
	public final static String CHANNEL_NAME_ALIPAY_MOBILE = "支付宝移动支付";
	public final static String CHANNEL_NAME_ALIPAY_PC = "支付宝PC支付";
	public final static String CHANNEL_NAME_ALIPAY_WAP = "支付宝WAP支付";
	public final static String CHANNEL_NAME_ALIPAY_QR = "支付宝当面付之扫码支付";
	public final static String CHANNEL_NAME_PC_MGR = "管理平台支付";
	public final static String CHANNEL_NAME_JD_PAY = "京东支付";
	public final static String CHANNEL_NAME_UNION_PAY = "银联支付";	

	public final static String CHANNEL_NAME_WX = "WX"; 				// 渠道名称:微信
	public final static String CHANNEL_NAME_ALIPAY = "ALIPAY"; 		// 渠道名称:支付宝
	public final static String CHANNEL_NAME_PC = "PC"; 		// 渠道名称:PC平台端
	...
	public final static byte ACCOUNT_BOOK_STATUS_SUCCESS = 1;	// 账单支付成功
	public final static byte ACCOUNT_BOOK_STATUS_FAIL = 2;		// 账单支付失败
