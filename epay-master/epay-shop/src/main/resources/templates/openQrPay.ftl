...
<footer class="footer">
    <div class="container">
        <p class="text-muted">&copy;2017 epay <script src="https://s13.cnzz.com/z_stat.php?id=1262480096&web_id=1262480096" language="JavaScript"></script></p>
    </div>
</footer>
...
<script>
    ...
    function makeCode () {
        ...
        $("#vAmt").text(vAmt+'元');
        //var qrText = 'http://epay-shop.ngrok.cc/goods/qrPay/' + (vAmt*100);
        var qrText = 'http://10.244.248.122:8081/goods/qrPay.html?amount=' + (vAmt*100);
