package org.epay.shop.controller;
...
import org.epay.common.util.*;
import org.epay.shop.dao.model.GoodsOrder;
import org.epay.shop.service.GoodsOrderService;
import org.epay.shop.util.Constant;
import org.epay.shop.util.OAuth2RequestParamHelper;
import org.epay.shop.util.vx.WxApi;
import org.epay.shop.util.vx.WxApiClient;
...
public class GoodsOrderController {
    ...
    //static final String baseUrl = "http://api.epay.org/api";
    static final String baseUrl = "http://127.0.0.1:3020/api";
    //static final String notifyUrl = "http://shop.epay.org/goods/payNotify";
    static final String notifyUrl = "http://127.0.0.1:8081/goods/payNotify";
    private AtomicLong seq = new AtomicLong(0L);
    private final static String QR_PAY_URL = "http://shop.epay.org/goods/qrPay.html";
    static final String AppID = "wx077cb62e341f8a5c";
    static final String AppSecret = "e663ea068f3e4f952f143de1432a35c2";
    private final static String GetOpenIdURL = "http://shop.epay.org/goods/getOpenId";
    private final static String GetOpenIdURL2 = "http://shop.epay.org/goods/getOpenId2";
    ...
    public String buy(@PathVariable("goodsId") String goodsId) {
        ...
        goodsOrder.setGoodsName("epay捐助商品G_0001");
        goodsOrder.setAmount(1l);
        goodsOrder.setUserId("epay_000001");
    ...
    void outResult(HttpServletResponse response, String content) {
        ...
        try {
            ...
            pw.print(content);
            _log.error("response epay complete.");
        } catch (IOException e) {
            _log.error(e, "response epay write exception.");
        }
    }
