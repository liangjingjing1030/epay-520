 ...
 */
@RestController
public class QueryRefundOrderDemo {
    ...
    static void queryRefundOrder() {
        ...
        reqBody.put("refund_order_id", "");	//退款订单号
        ...
        reqBody.put("offset", "10");	//每页数量
        reqParam.put("request_header", reqHeader);	//每页数量
        reqParam.put("request_body", reqBody);	//每页数量
