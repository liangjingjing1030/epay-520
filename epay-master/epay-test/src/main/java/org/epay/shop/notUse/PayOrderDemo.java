...
import org.epay.common.util.PayDigestUtil;
...
public class PayOrderDemo {
    ...
    static final String baseUrl = "http://192.168.174.1:3020/api";
    ...
    static String payOrderTest() {
        ...
        paramMap.put("subject", "epay支付测试");
        paramMap.put("body", "epay支付测试");
